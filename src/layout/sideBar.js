			...
			var tpl = [
				'<div class="side-container">', 
					...
					'<div class="block tag">',
					    ...
					    '<div class="tags">',
					        '<a href="" class="tag-link-15" title="1个话题" style="font-size: 12px;">冰雪聪明</a>',
							'<a href="" class="tag-link-19" title="1个话题" style="font-size: 12px;">领导</a>',
							'<a href="" class="tag-link-16" title="1个话题" style="font-size: 12px;">御姐</a>',
							'<a href="" class="tag-link-17" title="2个话题" style="font-size: 12px;">快乐</a>',
							'<a href="" class="tag-link-20" title="1个话题" style="font-size: 12px;">乐观</a>',
							'<a href="" class="tag-link-14" title="1个话题" style="font-size: 12px;">多愁善感</a>',
						'</div>',
					'</div>',
